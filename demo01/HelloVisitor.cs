...
public interface IHelloVisitor<Result> : IParseTreeVisitor<Result> {
	...
	Result VisitProgram([NotNull] HelloParser.ProgramContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitDeclaration([NotNull] HelloParser.DeclarationContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitMultiplication([NotNull] HelloParser.MultiplicationContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitAddition([NotNull] HelloParser.AdditionContext context);
	/// <summary>
